...
public class JIFrameDemo {
  ...
  public static void main(String[] a) {
   ...
   // JLabel reader = new JLabel("Mail Reader Would Be Here");
    mboxFrame.setContentPane(new JLabel("Mail Reader Would Be Here"));
    ...
    compFrame.setContentPane(new JLabel("Mail Compose Would Be Here"));
    ...
    listFrame.setContentPane(new JLabel("  Reader Would Be Here"));
